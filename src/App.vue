          ...
          <div v-if="!register" class="card-body">
            <div class="card-body">
              <div class="form-group">
                ...
                <input v-model="correo" type="email" class="form-control" placeholder="Ingrese su correo electrónico">
              </div>
              <div class="form-group">
                <label for="password">Contraseña:</label>
                <input v-model="contrasena" type="password" class="form-control" placeholder="Ingrese su contraseña">
              </div>
            </div>
          </div>
          <div v-else class="card-body">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input v-model="nombre" type="nombre" class="form-control" placeholder="Ingrese su nombre">
              </div>
              <div class="form-group">
                <label for="telefono">telefono</label>
                <input v-model="telefono" type="telefono" class="form-control" placeholder="Ingrese su telefono">
              </div>
              <div class="form-group">
                <label for="email">Correo electrónico:</label>
                <input v-model="correo" type="email" class="form-control" placeholder="Ingrese su correo electrónico">
              ...
              <div class="form-group">
                ...
                <select v-model="cargo" class="form-control">
                  <option v-for="(i, index) in cargos" :key="index" :value="i.id">{{ i.nombre }}</option>
                </select>
              </div>
              <div class="form-group">
                <label>departamento:</label>
                <select v-model="departamento" class="form-control">
                  <option v-for="(i, index) in departamentos" :key="index" :value="i.id">{{ i.nombre }}</option>
                </select>
              </div>
            </div>
          </div>
